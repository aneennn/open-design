...
export const esES: Dict = {
  ...
  'newproj.customAvatarToggle': 'Avatar personalizado',
  'newproj.customAvatarToggleHint': 'Marca esto si el ID pertenece a un avatar personalizado/clonado en lugar de un avatar del sistema',
  'newproj.customVoiceToggle': 'Voz personalizada',
  'newproj.customVoiceToggleHint': 'Marca esto si el ID pertenece a una voz personalizada/clonada en lugar de una voz del sistema',
