...
export const it: Dict = {
  ...
  'newproj.customAvatarToggle': 'Avatar personalizzato',
  'newproj.customAvatarToggleHint': "Seleziona se l'ID appartiene a un avatar personalizzato/clonato anziché a un avatar di sistema",
  'newproj.customVoiceToggle': 'Voce personalizzata',
  'newproj.customVoiceToggleHint': "Seleziona se l'ID appartiene a una voce personalizzata/clonata anziché a una voce di sistema",
