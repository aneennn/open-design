...
export const fa: Dict = {
  ...
  'newproj.customAvatarToggle': 'آواتار سفارشی',
  'newproj.customAvatarToggleHint': 'این را علامت بزنید اگر شناسه به یک آواتار سفارشی/کلون‌شده به‌جای آواتار سیستمی تعلق دارد',
  'newproj.customVoiceToggle': 'صدای سفارشی',
  'newproj.customVoiceToggleHint': 'این را علامت بزنید اگر شناسه به یک صدای سفارشی/کلون‌شده به‌جای صدای سیستمی تعلق دارد',
